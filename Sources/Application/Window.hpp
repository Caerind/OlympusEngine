...
class Window
{
	public:
		...
		OeSlot(oe::Window, onWindowClosed, mWindowCloseSlot);

		bool loadConfig(const std::string& filename = "window.ini");
		bool saveConfig(const std::string& filename = "window.ini");
