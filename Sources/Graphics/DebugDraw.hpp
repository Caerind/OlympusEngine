...
class DebugDraw : public Singleton<DebugDraw>
{
	public:
		...
		static void drawCircle(F32 x, F32 y, const Color& color = Color::Red, F32 r = 10.f);
		static void drawLine(F32 x1, F32 y1, F32 x2, F32 y2, const Color& color = Color::Red, F32 thickness = 2.0f);
